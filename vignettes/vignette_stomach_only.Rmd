...
mmu_obj <- LoadH5Seurat('/Users/ysong/SOFTWARE/scGOclust_data/mca_adult_stomach_counts.h5seurat')
...
pheatmap(corr, filename = 'stomach_unscaled.pdf', width = 10, height = 7)

pheatmap(corr, scale = 'column', filename = 'stomach_column_scaled.pdf', width = 10, height = 7)
