...
devtools::load_all("/Users/ysong/SOFTWARE/scGOclust")
...
```{r cell_type_corr_within, fig.width = 8,  fig.height = 8}
...
```{r heatmap_corr_cross, fig.width = 9,  fig.height = 10}
...
```{r sheatmap_corr_cross,  fig.width = 9,  fig.height = 10}
